...
export default function TodoModule() {
    ...
    const handleRemoveTask = value => {
        setAllTasks(prev => prev.filter(element => element !== value))
    }
        ...
        <div className={styles.todo}>
            {allTasks.map(task => {
                return (
                    <div key={task}>
                        <span>{task}</span>
                        <svg onClick={() => handleRemoveTask(task)} className={styles.delete} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 50 50'>
            ...
            <div>
                ...
                <svg onClick={handleAddTask} className={styles.send} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 45 45'>
